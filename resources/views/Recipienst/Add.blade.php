                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Name" name="name" value="{{old('name',Request::segment(3)?$recipienst->name:'')}}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1" placeholder="Id Proof" name="idproof" value="{{old('idproof',Request::segment(3)?$recipienst->idproof:'')}}">
                                @error('idproof')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
